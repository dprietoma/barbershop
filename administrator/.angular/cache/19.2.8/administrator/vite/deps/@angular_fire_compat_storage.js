...
import {
  ...
  ɵcacheInstance,
  ɵfirebaseAppFactory
} from "./chunk-2ZUKSSMO.js";
import {
  firebase
} from "./chunk-OUGIW6VF.js";
import {
  AsyncPipe
} from "./chunk-FDEOLCRA.js";
import "./chunk-XLJE2XJH.js";
import {
  Component,
  FirebaseError,
  SDK_VERSION,
...
function createStorageRef(ref2, injector) {
  return {
    getDownloadURL: () => of(void 0).pipe(observeOn(injector.get(ɵAngularFireSchedulers).outsideAngular), switchMap(() => ref2.getDownloadURL()), pendingUntilEvent(injector)),
    getMetadata: () => of(void 0).pipe(observeOn(injector.get(ɵAngularFireSchedulers).outsideAngular), switchMap(() => ref2.getMetadata()), pendingUntilEvent(injector)),
